...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-22 11:26`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/de53f787-6587-48fc-a855-5cc2d5a6021d.git
$ cd de53f787-6587-48fc-a855-5cc2d5a6021d
```
